...
dotnet build --framework netcoreapp2.1 --configuration Release ./src/apache/codegen/Avro.codegen.csproj
...
dotnet test --framework netcoreapp2.1 --configuration Release ./src/apache/test/Avro.test.csproj
