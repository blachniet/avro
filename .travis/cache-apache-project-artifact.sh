...
# This script was copied from the HBase project:
# https://github.com/apache/hbase/blob/1170f28122d9d36e511ba504a5263ec62e11ef6a/dev-support/jenkins-scripts/cache-apache-project-artifact.sh#L1
