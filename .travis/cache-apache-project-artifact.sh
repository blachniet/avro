...
# We copied this script from the HBase project here:
# https://github.com/apache/hbase/blob/78bae9e3d02e259cd9596fd72b1c985c2962c1c3/dev-support/jenkins-scripts/cache-apache-project-artifact.sh
